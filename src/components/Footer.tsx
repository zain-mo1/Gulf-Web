          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="https://wa.me/201038150652" target="_blank" rel="noopener noreferrer" className="text-body text-muted-foreground hover:text-primary transition-colors font-medium text-right" dir="ltr">
                  تواصل عبر واتساب
                </a>
              </li>
              <li className="flex items-center gap-3">
